...
public class MapState {
    ...
    public MapState(List<AnimalData> animalData, Set<MapLocation> foodData, int age, Bounds bounds, List<MapLocation> newGrassLocations, List<MapLocation> noLongerGrassLocations) {
